...
%
% Outputs:
%   OUTEEG - Output dataset. This function will create a struct in
...
% sorted by assigning the relevant variables from A_ll{K_opt} and
% L_all{K_opt}. Variables defined in sort_names_opt are sorted for K_opt 
...
for K = K_range
    ...
    %% Sorting for variables only available for K_opt.
    if K == OUTEEG.microstate.Res.K_opt
